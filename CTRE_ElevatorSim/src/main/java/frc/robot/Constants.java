...
public class Constants {
	...
	public static final double kPulleyRadiusMeters = Units.inchesToMeters(2);
	...
	public static final double kDistancePerTick = 2 * Math.PI * kPulleyRadiusMeters / kTicksPerRevolution / kGearRatio;

	public static final double kP  = .00265;
